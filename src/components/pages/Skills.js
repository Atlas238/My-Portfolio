        ...
        <Transition in={active === 0 ? true : false} timeout={0} unmountOnExit>
          {(state) => (
            ...
            >
              <h4>React</h4>
              <p>
                This portfolio right here was built on React! You can also find
                older React projects in the work section. Currently learning{" "}
                React Native...
              </p>
            </div>
          )}
        ...
        <Transition in={active === 2 ? true : false} timeout={0} unmountOnExit>
          {(state) => (
            ...
            >
              <h4>Javascript</h4>
              <p>
                My first and (currently) only language, with a heavy helping of
                Jsx to go along with. I hope to expand to Typescript soon!
              </p>
            </div>
          )}
        </Transition>
          ...
          {(state) => (
            ...
            >
              ...
              <p>
                ...
                enjoy user experience and being able to customize that
                experience.
              </p>
            </div>
          )}
